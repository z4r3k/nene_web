          ...
          <div class="col-xs-12">
            <div class="cd-slider-nav">
              <nav class="navbar navbar-expand-lg" id="tm-nav">
                <a style="color:#f98995" class="navbar-brand" href="#">甜心的饲养基地</a>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                <div class="intro-left tm-bg-dark">
                  <h2 style="color:#f98995" class="mb-4">Welcome to Nene's home </h2>
                  <p style="color:#f98995" class="mb-4">
                    郑乃馨（ Nene ），1997年6月25日出生于泰国曼谷，泰籍华裔歌手、演员。2020年参加中国选秀节目《创造营2020》，期间表现优异，在多次公演中获得全场最高的撑腰值，最终以总决赛第五名的成绩成团，是队内的 Vocal （声乐）担当。在毕业后成功签约索尼音乐并推出了自己的首张个人单曲《约定》，现已上线 QQ音乐、网易云音乐、苹果音乐等各大音乐平台。</p>
                  <p style="color:#f98995" class="mb-0">
                  「个人介绍」泰文全名：พรนับพันพรเพ็ญพิพัฒน์（ Pornnappan Pornpenpipat /普罗潘普潘皮帕）昵称：เนเน่（ Nene ）职业：演员/歌手官方粉丝名：氖原子应援色：乃馨色（色号：#f 98995） </p>
                </div>
                <div class="intro-right">
                  <img src="static/img/login4.jpg" alt="Image" class="img-fluid intro-img-1">
                </div>
            ...
            <div class="mx-auto position-relative gallery-container">
              ...
              <div class="mx-auto tm-border-top gallery-slider">
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-01.jpg" alt="Image">
                    <figcaption>
                        <div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-02.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-03.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-04.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-05.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-06.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-07.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-08.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="static/img/gallery-img-09.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
